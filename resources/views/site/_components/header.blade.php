...
<div id="topBar" class="dark">
    <div class="container">
        ...
        <ul class="top-links list-inline float-right">
            @auth
            <li class="text-welcome hidden-xs-down">Welcome to Smarty, <strong>{{ Auth::user()->name}}</strong></li>
            <li>
                @if (Auth::user()->hasRole('admin'))
                <a class="dropdown-toggle no-text-underline" href="{{ env('ADMIN_PATH_PREFIX') }}"><i class="fa fa-user hidden-xs-down"></i> Admin Panel</a>
                @elseif (Auth::user()->hasRole('writer'))
                <a class="dropdown-toggle no-text-underline" href="/writer"><i class="fa fa-user hidden-xs-down"></i> My Account</a>
                @endif
            </li>
            @else
        ...
        <ul class="top-links list-inline">
            ...
            <li>
                <a class="dropdown-toggle no-text-underline" data-toggle="dropdown" href="#"><img class="flag-lang" src="/themes/smarty_front/assets/images/_smarty/flags/us.png" width="16" height="11" alt="lang" /> ENGLISH</a>
                <ul class="dropdown-langs dropdown-menu">
                    <li><a tabindex="-1" href="#"><img class="flag-lang" src="/themes/smarty_front/assets/images/_smarty/flags/us.png" width="16" height="11" alt="lang" /> ENGLISH</a></li>
                    <li class="divider"></li>
                    <li><a tabindex="-1" href="#"><img class="flag-lang" src="/themes/smarty_front/assets/images/_smarty/flags/de.png" width="16" height="11" alt="lang" /> GERMAN</a></li>
                    <li><a tabindex="-1" href="#"><img class="flag-lang" src="/themes/smarty_front/assets/images/_smarty/flags/ru.png" width="16" height="11" alt="lang" /> RUSSIAN</a></li>
                    <li><a tabindex="-1" href="#"><img class="flag-lang" src="/themes/smarty_front/assets/images/_smarty/flags/it.png" width="16" height="11" alt="lang" /> ITALIAN</a></li>
                </ul>
            </li>
            <li>
    ...
    <header id="topNav">
        <div class="container">
            ...
            <a class="logo float-left" href="index.html">
                <img src="/themes/smarty_front/assets/images/_smarty/logo_dark.png" alt="" />
            </a>
                        ...
                        <li class="dropdown active"><!-- BLOG -->
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown active">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="active"><a href="blog-default-aside-left.html">LEFT SIDEBAR</a></li>
