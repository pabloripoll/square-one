...
use App\Http\Controllers\Writer\Dashboard\SectionController as Dashboard;
use App\Http\Controllers\Writer\Blog\SectionController as Blog;

class WriterModuleController extends Controller
{
        ...
        )
    {
        ...
        return view('writer.'.$data->layout, ['data' => $data]);
    }
    ...
    private function layout($request, $path)
    {
        ...
        method_exists(new WriterModuleController, $module) ?
